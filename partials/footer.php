                ...
                <div class="section-space">
                    ...
                    <div class="container">
                        ...
                        <div class="grid grid-cols-1 gap-x-10 gap-y-10 md:grid-cols-2 lg:grid-cols-[1fr_minmax(0,0.8fr)] lg:gap-x-20 xl:gap-x-24 xxl:gap-x-[139px]">
                            ...
                            <div>
                                ...
                                <div class="section-block text-colorButteryWhite">
                                    <h2 class="mb-6">
                                        ...
                                        Proyek Sertifikasi Bersama Kami
                                    </h2>

                                    <p class="section-para">
                                        Kami bekerja sama dengan peserta untuk memahami tujuan, kebutuhan, dan keahlian mereka, lalu memberikan solusi sertifikasi yang praktis dan terpercaya.
                            ...
                            <!-- Footer Right Block -->
                            <div>
                                <span class="display-heading display-heading-5 mb-[30px] block text-colorButteryWhite">Hubungi Kami untuk Informasi Sertifikasi</span>
